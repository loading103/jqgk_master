...
-keep class com.daqsoft.library_base.base.** { *; }
-keep class com.daqsoft.library_base.pojo.** { *; }
-keep class com.daqsoft.library_common.bean.** { *; }
...
-keep class com.daqsoft.module_statistics.repository.pojo.** { *; }
-keep class com.daqsoft.module_task.repository.pojo.** { *; }
-keep class com.daqsoft.module_work.repository.pojo.** { *; }
...
-keep class com.daqsoft.module_statistics.widget.** { *; }
-keep class com.daqsoft.module_task.widget.** { *; }
-keep class com.daqsoft.module_work.widget.** { *; }
