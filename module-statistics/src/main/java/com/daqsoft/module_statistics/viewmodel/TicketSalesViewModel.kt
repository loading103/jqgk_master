 ...
 * @describe
 */
class TicketSalesViewModel  : ToolbarViewModel<StatisticsRepository> {
    ...
    val salesEvent = SingleLiveEvent<TicketSales>()
    fun getTicketSales( timeType: String?,
                        statisticsTime: String?,
                        endTime: String?,
                        quarter: String?) {
        addSubscribe(
            model
                .getTicketSales(timeType, statisticsTime, endTime, quarter)
                .doOnSubscribe{
                    showLoadingDialog()
                }
                ...
                .subscribeWith(object : AppDisposableObserver<AppResponse<TicketSales>>() {
                    override fun onSuccess(t: AppResponse<TicketSales>) {
                        t.data?.let {
                            salesEvent.value = it
                        }
