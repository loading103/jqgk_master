 ...
 * @describe
 */
class PassengerFlowTimePeriodViewModel  : ToolbarViewModel<StatisticsRepository> {
    ...
    val timePeriodEvent = SingleLiveEvent<PassengerFlowTimePeriod>()
    fun getPassengerFlowTimePeriod(timeType: String?,
        ...
        addSubscribe(
            model
                .getPassengerFlowTimePeriod(timeType, statisticsTime, endTime, quarter,companyId)
                .doOnSubscribe{
                    showLoadingDialog()
                }
                ...
                .subscribeWith(object : AppDisposableObserver<AppResponse<PassengerFlowTimePeriod>>() {
                    override fun onSuccess(t: AppResponse<PassengerFlowTimePeriod>) {
                        t.data?.let {
