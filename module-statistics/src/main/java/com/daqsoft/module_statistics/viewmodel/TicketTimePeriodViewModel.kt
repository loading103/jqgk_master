 ...
 * @describe
 */
class TicketTimePeriodViewModel  : ToolbarViewModel<StatisticsRepository> {
    ...
    val timePeriodEvent = SingleLiveEvent<TicketTimePeriod>()
    fun getTicketTimePeriod(timeType: String?,
                            statisticsTime: String?,
                            endTime: String?,
                            quarter: String?) {
        addSubscribe(
            model
                .getTicketTimePeriod(timeType, statisticsTime, endTime, quarter)
                .doOnSubscribe{
                    showLoadingDialog()
                }
                ...
                .subscribeWith(object : AppDisposableObserver<AppResponse<TicketTimePeriod>>() {
                    override fun onSuccess(t: AppResponse<TicketTimePeriod>) {
                        t.data?.let {
