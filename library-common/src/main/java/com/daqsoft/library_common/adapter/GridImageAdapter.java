...
public class GridImageAdapter extends
    ...
    private int addImage = R.mipmap.picture_or_video;

    /**
     * 纯展示
     */
    private boolean pureDisplay = false;
    ...
    public GridImageAdapter(Context context, int addImage,onAddPicClickListener mOnAddPicClickListener) {
        this.mInflater = LayoutInflater.from(context);
    ...
    public void setPureDisplay(boolean pureDisplay) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = mInflater.inflate(R.layout.layout_choose_filter_image, viewGroup, false);
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            viewHolder.mImg.setBackgroundResource(addImage);
    ...
    public interface OnItemLongClickListener {
        void onItemLongClick(ViewHolder viewHolder , int position,View v);
    }
