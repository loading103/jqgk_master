...
package com.daqsoft.library_common.widget.navhost;
 ...
 */
public class MyNavHostFragment extends Fragment implements NavHost {
     ...
     * looking first for a {@link MyNavHostFragment} along the given Fragment's parent chain.
    ...
    public static NavController findNavController(@NonNull Fragment fragment) {
        ...
        while (findFragment != null) {
            if (findFragment instanceof MyNavHostFragment) {
                return ((MyNavHostFragment) findFragment).getNavController();
            }
            Fragment primaryNavFragment = findFragment.getParentFragmentManager()
                    .getPrimaryNavigationFragment();
            if (primaryNavFragment instanceof MyNavHostFragment) {
                return ((MyNavHostFragment) primaryNavFragment).getNavController();
            }
     ...
     */
    @NonNull
    public static MyNavHostFragment create(@NavigationRes int graphResId) {
    ...
    public static MyNavHostFragment create(@NavigationRes int graphResId,
        ...
        final MyNavHostFragment result = new MyNavHostFragment();
        if (b != null) {
     ...
     * <p>
     * By default, this adds a {@link MyFragmentNavigator}.
     * <p>
    ...
    protected void onCreateNavController(@NonNull NavController navController) {
        navController.getNavigatorProvider().addNavigator(
                new MyDialogFragmentNavigator(requireContext(), getChildFragmentManager()));
    ...
    public void onAttachFragment(@NonNull Fragment childFragment) {
        ...
        MyDialogFragmentNavigator dialogFragmentNavigator =
                mNavController.getNavigatorProvider().getNavigator(MyDialogFragmentNavigator.class);
     ...
     * {@link MyFragmentNavigator}, which replaces the entire contents of the NavHostFragment.
     * <p>
     * This is only called once in {@link #onCreate(Bundle)} and should not be called directly by
     * subclasses.
    ...
    @Deprecated
    @NonNull
    protected Navigator<? extends MyFragmentNavigator.Destination> createFragmentNavigator() {
