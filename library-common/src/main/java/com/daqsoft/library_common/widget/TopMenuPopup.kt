...
import com.daqsoft.library_common.adapter.ListPopupAdapter
 ...
 * @describe
 */
class TopMenuPopup(context: Context) : PartShadowPopupView(context) {
    ...
    private fun initRecycleView() {
        ...
        recycleView.apply {
            ...
            adapter = listPopupAdapter.apply {
                itemBinding = ItemBinding.of(ItemBinding.VAR_NONE, R.layout.recyclerview_list_popup_item)
                setItems(data)
