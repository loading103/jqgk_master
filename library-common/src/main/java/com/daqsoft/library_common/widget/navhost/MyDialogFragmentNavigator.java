...
public final class MyDialogFragmentNavigator extends Navigator<MyDialogFragmentNavigator.Destination> {
    ...
    public MyDialogFragmentNavigator(@NonNull Context context, @NonNull FragmentManager manager) {
        mContext = context;
    ...
    /**
     * NavDestination specific to {@link MyDialogFragmentNavigator}.
     */
    ...
    public static class Destination extends NavDestination implements FloatingWindow {
        ...
        public Destination(@NonNull NavigatorProvider navigatorProvider) {
            this(navigatorProvider.getNavigator(MyDialogFragmentNavigator.class));
        }
         ...
         * Fragment via {@link #setClassName(String)}.
         *
         * @param fragmentNavigator The {@link MyDialogFragmentNavigator} which this destination
