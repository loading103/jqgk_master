...
class HomeModule {
    ...
    @Singleton
    @Provides
    fun provideTaskApiService() = RetrofitClient.Builder().build().create(HomeApiService::class.java)

    @Singleton
    @Provides
    fun provideHomeRepository(homeApiService: HomeApiService)  = HomeRepository(homeApiService)
