...
class SideBar : View {
    ...
    private fun initView(context: Context?, attrs: AttributeSet?){
        ...
        mNormalTextColor = typedArray.getColor(R.styleable.SideBar_sidebar_normal_text_color, resources.getColor(R.color.color_999999))
        mSelectedTextColor = typedArray.getColor(R.styleable.SideBar_sidebar_selected_text_color, resources.getColor(R.color.color_333333))
