 ...
 * @date 6/7/2021 下午 2:10
 * @author zp
 * @describe
 */
class SupplementCardListViewModel : ToolbarViewModel<WorkRepository> , Paging2Utils<Any> {
    ...
    override fun rightIconOnClick() {
        ARouter.getInstance().build(ARouterPath.Workbench.PAGER_ADD_SUPPLEMENT_CARD).navigation()
    }
